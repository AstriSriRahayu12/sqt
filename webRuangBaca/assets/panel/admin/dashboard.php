...
if (!isset($_SESSION['lib-name'])) {
  header("location: ../../webpages/login.php"); //ganti ke login member
}
...
<body onload="preloader()">
  ...
  <div class="sidebar close">
    <ul class="nav-links">
      ...
      <li class="active">
        ...
        <ul class="sub-menu">
          <li><a href="admin-pages/add-book.php">Tambah Buku</a></li>
          <li><a href="admin-pages/view-book.php">Lihat Buku</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
        ...
        <ul class="sub-menu blank">
          <li><a href="admin-pages/category.php">Kategori</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <div class="logout">
        <button><a href="admin-pages/logout.php">Keluar</a></button>
      </div>
    </div>
