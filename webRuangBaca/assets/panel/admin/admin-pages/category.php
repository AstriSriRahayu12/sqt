                    ...
                    <div class="return-form">
                        <form method="POST" class="input-form">
                            <div class="input-field">
                                ...
                                <input type="text" name="category" id="category" value="" placeholder="Masukkan Kategori" />
                            </div>

                            <input type="submit" name="add-cat" value="Tambahkan Kategori">
                        </form>
                    </div>
                </div>
            </div>
